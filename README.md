...
Chatify App backend server is an interesting real-time social network application. It is developed using [node.js](https://nodejs.org/en/), [typescript](https://www.typescriptlang.org/), [redis](https://redis.io/download/) and [mongodb](https://www.mongodb.com/docs/manual/administration/install-community/).
...
```bash
git clone -b develop https://github.com/engr-Aman-ur-Rehman/Chatify-backend.git
cd chatify-backend
npm install
```
...
## API Endpoints
- The actual endpoints for the application can be found inside the folder named `endpoints` [https://github.com/engr-Aman-ur-Rehman/Chatify-backend/tree/develop/endpoints](https://github.com/engr-Aman-ur-Rehman/Chatify-backend/tree/develop/endpoints). 
